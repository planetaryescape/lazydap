...
- [ ] [M22 — Third adapter: delve](docs/implementation/tasks/M22-delve-adapter.md) — Go via dlv dap; added 2026-07-31 from the competitive audit
...
- [ ] [M23 — Fourth adapter: js-debug](docs/implementation/tasks/M23-jsdebug-adapter.md) — Node; BLOCKED: the spike proved js-debug needs a single-level child-session milestone first (0 stops without startDebugging). Deferred behind attach.
