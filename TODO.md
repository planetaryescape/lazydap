...
- **v0.1.0 shipped 2026-07-31; v0.2.0 through v0.2.7 shipped 2026-08-18.** All nine went out
...
- **The 2026-08-18 defect campaign.** An audit of the whole surface found defects in every part
  ...
  ran the real adapters (v0.2.6); and this docs sweep (v0.2.7). The protocol went **v8 → v9** on
  the way (D086), and decisions **D084–D099** record the rules that changed; the CHANGELOG sections say what a
