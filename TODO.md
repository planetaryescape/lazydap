...
- [ ] [M21 — Packaging: install.sh and Homebrew](docs/implementation/tasks/M21-packaging.md) — added 2026-07-31 after the fresh-install audit; the two channels the ship-it checklist records as missing
