...
chapter: 31
session_id: M13-2
title: Lazy expand variables
phase: D
estimated_time_minutes: 90
artifact: Enter on a variable expands its children
status: stub
related_milestone: docs/implementation/tasks/M13-scopes-pane.md
---

# Chapter 31 — Lazy expand variables
...
> Session ID: `M13-2` · Phase D · ~90 min · [Underlying milestone](../implementation/tasks/M13-scopes-pane.md)

## What you'll learn

The variables_reference correlation pattern. Send Variables request, receive children, populate the node, re-render. Request/response correlation by request id, the loaded vs expanded state distinction, why we don't pre-fetch.

## What you'll build

Enter on a variable expands its children
...
The companion teaching-notes file at `docs/teaching/notes/31-lazy-expand-variables.md` will be created during the live session.

## See also

- ← [Chapter 30-scope-tree-render](30-scope-tree-render.md)
- → [Chapter 32-toggle-breakpoint](32-toggle-breakpoint.md)
- [Underlying milestone](../implementation/tasks/M13-scopes-pane.md)
