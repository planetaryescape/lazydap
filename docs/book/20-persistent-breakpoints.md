...
chapter: 20
session_id: M6-4
title: Persistent breakpoints
phase: B
estimated_time_minutes: 90
artifact: Breakpoints persist across daemon restarts
status: stub
related_milestone: docs/implementation/tasks/M06-cli-subcommands.md
---

# Chapter 20 — Persistent breakpoints
...
> Session ID: `M6-4` · Phase B · ~90 min · [Underlying milestone](../implementation/tasks/M06-cli-subcommands.md)

## What you'll learn

break add/list/remove/toggle plus crates/store for .lazydap/state.toml reads/writes. TOML serialisation with serde, debounced disk writes, the BreakpointId vs adapter id distinction.

## What you'll build

Breakpoints persist across daemon restarts
...
The companion teaching-notes file at `docs/teaching/notes/20-persistent-breakpoints.md` will be created during the live session.
