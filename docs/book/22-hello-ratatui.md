...
artifact: lazydap-tui shows centred text in your terminal
status: stub
related_milestone: docs/implementation/tasks/M08-hello-ratatui.md
---

# Chapter 22 — Hello ratatui
...
> Session ID: `M8-1` · Phase C · ~90 min · [Underlying milestone](../implementation/tasks/M08-hello-ratatui.md)

## What you'll learn

ratatui's draw loop. Empty TUI, lazydap centred, q quits. The immediate-mode rendering model, why ratatui re-draws every frame, raw mode + alternate screen ritual.

## What you'll build

lazydap-tui shows centred text in your terminal
...
The companion teaching-notes file at `docs/teaching/notes/22-hello-ratatui.md` will be created during the live session.

## See also

- ← [Chapter 21-skill-zip-agent-verification](21-skill-zip-agent-verification.md)
- → [Chapter 23-source-pane-scrolling](23-source-pane-scrolling.md)
- [Underlying milestone](../implementation/tasks/M08-hello-ratatui.md)
