...
- D075 in [`docs/blueprint/15-decision-log.md`](../blueprint/15-decision-log.md) — the handles that make this unreachable
...
- D077 in [`docs/blueprint/15-decision-log.md`](../blueprint/15-decision-log.md)
...
- D076 in [`docs/blueprint/15-decision-log.md`](../blueprint/15-decision-log.md)
...
- D099 in [`docs/blueprint/15-decision-log.md`](../blueprint/15-decision-log.md)
