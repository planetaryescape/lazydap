...
| `BadRequest` | The request made no sense here — commonly stepping a program that has already exited. | Read `message`; it says what to do. For a finished program, launch again. |
