...
description: "All 27 codelldb behaviours that have cost this project time, each with its cause and its fix."
---

:::note[Generated page]
From [`docs/reference/codelldb-quirks.md`](https://github.com/planetaryescape/lazydap/blob/main/docs/reference/codelldb-quirks.md) in the repository, which is where these are written as they are found. To change this page, change that file, then run `npm run generate` in `site/` and commit the result. CI fails if the two disagree.
:::
...
- Issue: [`docs/issues/0001-codelldb-symlink-install-broken.md`](https://github.com/planetaryescape/lazydap/blob/main/docs/issues/0001-codelldb-symlink-install-broken.md)
- Chapter: [`docs/book/04-hello-adapter.md`](https://github.com/planetaryescape/lazydap/blob/main/docs/book/04-hello-adapter.md)
- Install instructions: [`CONTRIBUTING.md`](https://github.com/planetaryescape/lazydap/blob/main/CONTRIBUTING.md) (codelldb section)
...
- Issue: [`docs/issues/0002-codelldb-version-drift-rust-log.md`](https://github.com/planetaryescape/lazydap/blob/main/docs/issues/0002-codelldb-version-drift-rust-log.md)
- Chapter: [`docs/book/04-hello-adapter.md`](https://github.com/planetaryescape/lazydap/blob/main/docs/book/04-hello-adapter.md)
- Milestone: [`docs/implementation/tasks/M00-hello-adapter.md`](https://github.com/planetaryescape/lazydap/blob/main/docs/implementation/tasks/M00-hello-adapter.md)
...
- DAP protocol cheatsheet: [`docs/reference/dap-protocol-cheatsheet.md`](https://github.com/planetaryescape/lazydap/blob/main/docs/reference/dap-protocol-cheatsheet.md)
...
- [`CONTRIBUTING.md`](https://github.com/planetaryescape/lazydap/blob/main/CONTRIBUTING.md) — install verification step uses `codelldb --help`
...
- [`docs/issues/0001-codelldb-symlink-install-broken.md`](https://github.com/planetaryescape/lazydap/blob/main/docs/issues/0001-codelldb-symlink-install-broken.md) — the adjacent install footgun
...
- Milestone: [`docs/implementation/tasks/M05-ipc-protocol-daemon.md`](https://github.com/planetaryescape/lazydap/blob/main/docs/implementation/tasks/M05-ipc-protocol-daemon.md) — follow-ups
- [`docs/blueprint/10-async-to-sync.md`](https://github.com/planetaryescape/lazydap/blob/main/docs/blueprint/10-async-to-sync.md) — where the `--wait` reason semantics get decided
...
- [`docs/blueprint/15-decision-log.md`](https://github.com/planetaryescape/lazydap/blob/main/docs/blueprint/15-decision-log.md) — D034
- Milestone: [`docs/implementation/tasks/M06-cli-subcommands.md`](https://github.com/planetaryescape/lazydap/blob/main/docs/implementation/tasks/M06-cli-subcommands.md)
...
- [`CONTRIBUTING.md`](https://github.com/planetaryescape/lazydap/blob/main/CONTRIBUTING.md) — the warning where somebody about to do this will see it
- D048 in [`docs/blueprint/15-decision-log.md`](https://github.com/planetaryescape/lazydap/blob/main/docs/blueprint/15-decision-log.md) — the retry, and what bounds it
- `crates/daemon/src/adapter/mod.rs::rebind_source` — the two guards, in code
- Milestone: [`M15-config-file.md`](https://github.com/planetaryescape/lazydap/blob/main/docs/implementation/tasks/M15-config-file.md) — where source-path handling landed
...
- D045 in [`docs/blueprint/15-decision-log.md`](https://github.com/planetaryescape/lazydap/blob/main/docs/blueprint/15-decision-log.md)
...
- [`delve-quirks.md`](/reference/delve-quirks/) quirk 12 — the adapter that omits the field entirely
...
- D094 in [`docs/blueprint/15-decision-log.md`](https://github.com/planetaryescape/lazydap/blob/main/docs/blueprint/15-decision-log.md)
...
- D095 in [`docs/blueprint/15-decision-log.md`](https://github.com/planetaryescape/lazydap/blob/main/docs/blueprint/15-decision-log.md)
